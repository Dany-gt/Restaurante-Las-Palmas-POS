-- Script Definitivo: Histórico de Auditoría SAT (Alineación Total 2026)
CREATE TABLE IF NOT EXISTS historico_auditoria_sat (
  ...
  impuesto_bebidas_alcoh NUMERIC(12,2) DEFAULT 0,
  impuesto_bebidas_no_alcoh NUMERIC(12,2) DEFAULT 0,
...
-- Indices para consultas rapidas - Requisitos SAT
CREATE INDEX IF NOT EXISTS idx_auditoria_emisor_nit 
  ON historico_auditoria_sat(emisor_nit);
CREATE INDEX IF NOT EXISTS idx_auditoria_periodo 
  ON historico_auditoria_sat(periodo_fiscal_anio, 
  periodo_fiscal_mes);
CREATE INDEX IF NOT EXISTS idx_auditoria_estado 
  ON historico_auditoria_sat(estado);
CREATE INDEX IF NOT EXISTS idx_auditoria_tipo_dte 
  ON historico_auditoria_sat(tipo_dte);
CREATE INDEX IF NOT EXISTS idx_auditoria_credito_fiscal 
  ON historico_auditoria_sat(afecta_credito_fiscal);
CREATE INDEX IF NOT EXISTS idx_auditoria_giro 
  ON historico_auditoria_sat(emisor_giro);
