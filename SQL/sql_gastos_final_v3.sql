-- ==============================================================================
-- SISTEMA DE GESTIÓN DE GASTOS - PATCH V3 (CORRECCIÓN TIPO DATO)
-- Corrige el error 42809 asumiendo que el campo 'permissions' es JSONB
-- ==============================================================================
...
-- Nueva Política de Gestión (JSONB Support)
create policy "Permitir gestión de categorías a administradores y cajeros"
  ...
  using (
    ...
    (exists (
      ...
      where p.id = auth.uid()
      -- Validamos existencia en JSONB array
