        ...
        <div className="fixed inset-0 bg-black/20 flex justify-center items-center z-[999999] backdrop-blur-[1px]">
            ...
            >
                ...
                <div className="flex items-center gap-5 p-6 pt-8 pb-6 bg-[#f0f0f0]">
                    {/* Neutralized Icon */}
                    <div className="w-[42px] h-[42px] min-w-[42px] rounded-xl bg-[#333] flex justify-center items-center relative text-white border border-white/20 shadow-lg shrink-0">
                        {isAlert ? (
                ...
                <div className="bg-[#f0f0f0] px-4 pb-4 pt-2 flex justify-end gap-2.5">
                    <button
                        ref={confirmBtnRef}
                        onClick={onConfirm}
                        className="min-w-[90px] h-[28px] bg-[#333] hover:bg-[#444] border border-[#000] text-white text-[11px] font-black uppercase tracking-widest focus:outline-none relative group transition-all active:scale-95 shadow-sm"
                    >
                    ...
                    {!isAlert && onDeny && (
                        <button
                            onClick={onDeny}
                            className="min-w-[90px] h-[28px] bg-[#e1e1e1] hover:bg-[#d5d5d5] border border-[#adadad] text-black text-[11px] font-black uppercase tracking-widest focus:outline-none relative group transition-all active:scale-95 shadow-sm"
                        >
