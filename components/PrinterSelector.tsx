        ...
        <div className="fixed inset-0 z-[200] flex items-center justify-center bg-black/80 p-4 animate-fade-in">
            <div className="w-full max-w-md bg-[#1a1c23] rounded-3xl border border-white/10 shadow-2xl overflow-hidden">
                <div className="p-6 border-b border-white/5 flex justify-between items-center bg-white/5">
                    <h3 className="text-xl font-semibold uppercase tracking-tighter text-white">Configurar Impresora Local</h3>
                ...
                <div className="p-6">
                            ...
                            >
                                <div className="flex items-center gap-3">
                                    ...
                                    <div className="text-left">
                                        <div className="font-medium text-sm uppercase">Automático</div>
                            ...
                            {printers.map((p) => (
                                ...
                                >
                                    <div className="flex items-center gap-3">
                                        ...
                                        <div className="text-left">
                                            <div className="font-medium text-sm uppercase truncate max-w-[200px]">{p.name}</div>
                    ...
                    <div className="mt-6">
                        <button
                            onClick={onClose}
                            className="w-full py-4 bg-indigo-600 hover:bg-indigo-500 text-white rounded-2xl font-semibold uppercase tracking-widest text-xs shadow-lg shadow-indigo-600/20 transition-all active:scale-95"
                        >
                            Guardar y Cerrar
                        </button>
                    </div>
