                            ...
                            <table className="w-full border-collapse text-[11px]">
                                <tbody>
                                    <tr className="h-8">
                                        {mode === 'REP_DELETED' ? (
                                            <>
                                                <td className="px-4 font-medium uppercase tracking-widest text-[11px] text-slate-500">Resumen de Eliminaciones</td>
                                                <td className="px-4 text-center font-semibold text-[12px] text-slate-800 w-24">{globalCount}</td>
                                                <td className="w-24"></td>
                                                <td className="w-48"></td>
                                                <td className="px-4 text-right font-medium text-slate-500 uppercase text-[11px] w-28">Total</td>
                                                <td className="px-4 text-right font-semibold text-[12px] text-slate-900 w-28 tabular-nums">{formatCurr(globalTotal)}</td>
                                            </>
                                        ) : (
                                            <>
                                                {mode === 'REP_SOLD_USER' ? (
                                                    <td className="px-4 font-medium uppercase tracking-widest text-slate-500 text-[11px]" colSpan={2}>Total General</td>
                                                ) : (
                                                    <td className="px-4 font-medium uppercase tracking-widest text-slate-500 text-[11px]">Total General</td>
                                                )}
                                                <td className="px-4 text-center font-semibold text-[12px] text-slate-800 w-32">
                                                    {globalCount}
                                                </td>
                                                <td className="px-4 text-right font-semibold text-[12px] text-slate-900 w-32 tabular-nums">
                    ...
                    <div className="bg-[#f0f0f0] border-2 border-slate-800 shadow-2xl w-[950px] h-[90%] flex flex-col scale-in-center overflow-hidden">
                        ...
                        <div className="flex-1 overflow-auto bg-gray-200 p-8">
                            <div ref={printRef} className="bg-white shadow-lg p-10 min-h-full w-[25cm] mx-auto text-black">
                                ...
                                <table className="w-full text-[10px]">
                                    ...
                                    <tfoot className="border-t-4 border-double border-black mt-4">
                                        <tr>
                                            {mode === 'REP_DELETED' ? (
                                                <>
                                                    <td className="py-4 font-semibold uppercase text-base">TOTAL ELIMINACIONES</td>
                                                    <td className="py-4 text-center font-semibold text-lg">{globalCount}</td>
                                                    <td colSpan={3}></td>
                                                    <td className="py-4 text-right font-semibold text-lg">TOTAL PÉRDIDA</td>
                                                    <td className="py-4 text-right font-semibold text-xl">{formatCurr(globalTotal)}</td>
                                                </>
                                            ) : (
                                                <>
                                                    <td className="py-4 font-semibold uppercase text-base" colSpan={mode === 'REP_SOLD_USER' ? 2 : 1}>TOTAL GENERAL</td>
                                                    <td className="py-4 text-center font-semibold text-lg">{globalCount}</td>
                                                    <td className="py-4 text-right font-semibold text-xl">{formatCurr(globalTotal)}</td>
                                                </>
                                            )}
                                ...
                                <div className="mt-10 border-t border-gray-300 pt-4 opacity-50 text-[10px] uppercase font-medium flex justify-between">
