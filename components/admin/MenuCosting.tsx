            ...
            <header className="bg-white border-b border-[#106ebe]/10 px-4 py-2 flex items-center justify-between shadow-sm z-20">
                <div className="flex items-center gap-4 divide-x divide-gray-100 font-sans">
                    <div className="relative min-w-[260px]">
                        ...
                        <select
                            className="w-full bg-gray-50 border border-gray-200 rounded-md pl-8 pr-8 py-1.5 text-[11px] font-bold focus:ring-1 focus:ring-[#106ebe] outline-none appearance-none"
                            onChange={(e) => {
                    ...
                    <div className="pl-4 flex flex-col">
                        <span className="text-[8px] font-black text-gray-400 uppercase tracking-widest leading-none mb-1">Precio Actual (IVA Inc.)</span>
                    ...
                    <div className="pl-4 flex flex-col">
                        <span className="text-[8px] font-black text-gray-400 uppercase tracking-widest leading-none mb-1">Régimen IVA</span>
                        <button
                            onClick={() => {
                            ...
                            className={`flex items-center gap-1 px-2 py-0.5 rounded text-[8px] font-black uppercase tracking-tight border transition-all ${isNormalContributor
                ...
                <div className="flex items-center gap-2">
                    <button
                        ...
                        className="px-3 py-1.5 bg-gray-50 border border-gray-200 text-[#106ebe] rounded-md text-[9px] font-black uppercase tracking-widest hover:bg-gray-100 transition-all flex items-center gap-2 disabled:opacity-60"
                    ...
                    <button
                        ...
                        className="px-4 py-1.5 bg-[#106ebe] text-white rounded-md text-[9px] font-black uppercase tracking-widest hover:bg-black transition-all shadow-md shadow-gray-200 flex items-center gap-2 disabled:opacity-60"
                    >
                        ...
                        <div className="bg-white border border-[#106ebe]/10 rounded-lg p-3 shadow-sm">
                            ...
                            <div className="bg-orange-50/60 border border-orange-100 rounded-md p-2 space-y-1.5">
                                ...
                                <div className="border-t border-orange-200 pt-1.5 mt-1 flex justify-between items-center">
                                    <span className="text-[7.5px] font-black text-orange-600 uppercase">Costo Real Mensual ({numberOfCooks} cocineros)</span>
                                    <span className="text-[12px] font-black text-orange-600">Q {monthlyLaborTotalReal.toFixed(2)}</span>
                                </div>
                            </div>
                            ...
                            <div className="mt-2 bg-[#106ebe]/5 rounded p-2 space-y-1">
                                ...
                                <div className="flex justify-between text-[7.5px] font-bold text-gray-500 uppercase">
                                    ...
                                    <span className="text-[#106ebe] font-black">Q {costPerMinute.toFixed(4)}</span>
                                </div>
                            </div>
                    ...
                    <section className="bg-white border border-[#106ebe]/10 rounded-lg p-4 shadow-sm">
                        ...
                        {belowBreakeven ? (
                            <div className="mb-3 bg-rose-50 border border-rose-200 rounded-md px-3 py-2 flex items-start gap-2">
                                ...
                                <p className="text-[8px] font-bold text-rose-700 leading-snug">
                                    Con tu volumen actual ({totalMonthlyPortions.toLocaleString()} uds) NO cubres gastos fijos.
                                    Necesitas vender <span className="font-black">{Math.ceil(peUnidades - totalMonthlyPortions).toLocaleString()} unidades más</span> al mes para alcanzar el equilibrio.
                                </p>
                            </div>
                        ) : (
                            <div className="mb-3 bg-emerald-50 border border-emerald-200 rounded-md px-3 py-2 flex items-start gap-2">
                                ...
                                <p className="text-[8px] font-bold text-emerald-700 leading-snug">
                                    Tu volumen de ventas cubre los gastos fijos. ¡Alcanzas el equilibrio en <span className="font-black">{Math.ceil(daysToBreakeven)} días</span> del mes!
                                </p>
                            </div>
                        )}
                        ...
                        <div className="grid grid-cols-4 gap-2">
                            ...
                            <div className="bg-gray-50 border border-gray-100 rounded-md p-2 text-center">
                                <span className="text-[7px] font-black text-gray-400 uppercase block mb-1">Días al Equilibrio</span>
                                <span className="text-[13px] font-black text-[#106ebe]">{Math.ceil(daysToBreakeven)}</span>
                                <span className="text-[6.5px] font-bold text-gray-300 uppercase block mt-0.5">Del mes operativo</span>
                            </div>
                            <div className={`border rounded-md p-2 text-center ${safetyMarginPct > 20 ? 'bg-emerald-50 border-emerald-200'
                                ...
                                <span className="text-[7px] font-black text-gray-400 uppercase block mb-1">Margen Seguridad</span>
                                <span className={`text-[13px] font-black ${safetyMarginPct > 20 ? 'text-emerald-600'
                                    : safetyMarginPct > 10 ? 'text-amber-600'
                                        : 'text-rose-600'
                                    }`}>{safetyMarginPct.toFixed(1)}%</span>
                                <span className={`text-[6.5px] font-black uppercase block mt-0.5 ${safetyMarginPct > 20 ? 'text-emerald-500'
                                ...
                                (() => {
                                    ...
                                    if (isPopular && isRentable) return (
                                        <div className="flex flex-col items-center">
                                            ...
                                            <span className="text-[9px] font-black text-emerald-600 uppercase tracking-widest">Plato Estrella ⭐</span>
                                            <p className="text-[7px] text-gray-400 font-bold uppercase mt-1">Protección y Promoción<br />Alta Rentabilidad y Venta</p>
                                        </div>
                                    );
                                    if (isPopular && !isRentable) return (
                                        <div className="flex flex-col items-center">
                                            ...
                                            <span className="text-[9px] font-black text-orange-600 uppercase tracking-widest">Caballo de Batalla 🐴</span>
                                            <p className="text-[7px] text-gray-400 font-bold uppercase mt-1">Optimizar Costos<br />Alta Venta, Bajo Margen</p>
                                        </div>
                                    );
                                    return (
                                        <div className="flex flex-col items-center">
                                            ...
                                            <span className="text-[9px] font-black text-indigo-600 uppercase tracking-widest">Acertijo / Puzzle 🧩</span>
                                            <p className="text-[7px] text-gray-400 font-bold uppercase mt-1">Impulsar Venta<br />Rentable pero poco vendido</p>
                                        </div>
                                    );
                                })()
                            ) : (
                ...
                <div className="fixed inset-0 bg-[#106ebe]/80 z-50 flex flex-col pt-10 pb-10 px-10 overflow-hidden backdrop-blur-sm print:p-0 print:bg-white print:block">
                    <div className="bg-white mx-auto w-full max-w-6xl flex-1 rounded-xl shadow-2xl flex flex-col overflow-hidden print:shadow-none print:h-auto print:overflow-visible relative">
                        ...
                        <div className="flex justify-between items-center p-6 border-b border-gray-100 print:hidden">
                            <h2 className="text-xl font-black text-[#106ebe] uppercase tracking-widest flex items-center gap-3">
                                <PieChart size={24} className="text-[#3c7cbc]" /> Resumen de Rentabilidad del Menú
                            </h2>
                            <div className="flex items-center gap-4">
                                <button onClick={() => window.print()} className="px-6 py-2 bg-[#3c7cbc] text-white rounded-lg font-black uppercase text-xs tracking-widest shadow-md hover:bg-blue-700 transition-colors flex items-center gap-2">
                            ...
                            <table className="w-full text-left border-collapse">
                                ...
                                <tbody>
                                    {globalReportData.map((row, i) => {
                                        ...
                                        return (
                                            <tr key={i} className="border-b border-gray-100 text-[11px] font-bold hover:bg-gray-50/40 print:break-inside-avoid">
                                                <td className="p-4 text-gray-800">
                                                    {row.name}
                                                    {!row.hasRecipe && <span className="ml-2 text-[8px] bg-amber-100 text-amber-700 px-1.5 py-0.5 rounded uppercase tracking-widest font-black">Sin Receta</span>}
                                                </td>
                                                <td className="p-4 text-gray-400 text-[9px] uppercase tracking-wider">{row.category}</td>
                                                <td className="p-4 text-right text-rose-700 font-black bg-rose-50/30">Q {row.totalCost.toFixed(2)}</td>
                                                <td className="p-4 text-right text-gray-600">Q {row.currentPrice.toFixed(2)}</td>
                                                <td className="p-4 text-right bg-emerald-50/50">
                                                    <div className="font-black text-emerald-700 text-sm">Q {row.suggestedPrice.toFixed(2)}</div>
                                                    {delta > 0.05 && <div className="text-[9px] text-amber-600 font-black mt-0.5 uppercase">+ Q {delta.toFixed(2)} Recomendado</div>}
                                                    {delta < -0.05 && <div className="text-[9px] text-gray-400 font-bold mt-0.5 uppercase mb-[-4px]">Sobre-rentable</div>}
                                                </td>
                                                <td className="p-4 text-right">
                                                    <span className={`inline-block px-2 py-1 rounded-md text-[10px] uppercase font-black tracking-widest text-white ${row.isRentable ? 'bg-emerald-500' : 'bg-rose-500'}`}>
                                                        {row.netMarginPct.toFixed(1)}%
                                                    </span>
                                                    <div className="text-[8px] text-gray-400 uppercase tracking-widest font-black mt-1">META: {row.activeFc}%</div>
                                                </td>
                                            </tr>
                                        );
                                    })}
