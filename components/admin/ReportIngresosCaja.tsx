        ...
        <div className="flex flex-col h-full bg-[#f0f0f0] font-sans text-[11px] overflow-hidden">
                    ...
                    <div className="flex items-center justify-between px-4">
                        <div className="flex items-center gap-6">
                            ...
                            <div className="flex items-center gap-2 capitalize">
                                ...
                                <button onClick={() => setShowTotals(!showTotals)} className="h-7 px-4 bg-white border border-gray-400 hover:bg-gray-100 flex items-center gap-2 shadow-sm font-medium text-black text-[11px] active:bg-gray-200 transition-colors">
                    ...
                    <tbody className="divide-y divide-gray-200">
                        ...
                        {filteredData.map((row, idx) => (
                            ...
                            >
                                ...
                                <td className="border border-gray-300 px-4 text-black text-[11px] font-medium"><div className="flex justify-between w-full"><span className="text-gray-400 font-normal">Q</span><span className="tabular-nums text-right">{formatCurr(row.totalCuenta)}</span></div></td>
                                <td className="border border-gray-300 pr-10 text-black text-[11px] font-semibold bg-white"><div className="flex justify-between w-full"><span className="text-gray-400 font-normal ml-2">Q</span><span className="tabular-nums text-right">{formatCurr(row.totalPagado)}</span></div></td>
            ...
            >
                <table className="w-full border-collapse border-spacing-0 table-fixed min-w-[1770px]">
                    ...
                    <tbody>
                        <tr className="h-8 uppercase font-medium text-[11px] text-slate-800">
                            ...
                            <td className="px-4 border-r border-gray-200 font-semibold"><div className="flex justify-between w-full"><span className="text-gray-400 font-normal">Q</span><span className="tabular-nums text-right text-slate-900">{formatCurr(totals.totalCuenta)}</span></div></td>
                            <td className="pr-10 border-r border-gray-200 font-semibold"><div className="flex justify-between w-full"><span className="text-gray-400 font-normal ml-2">Q</span><span className="tabular-nums text-right text-slate-900">{formatCurr(totals.totalPagado)}</span></div></td>
