                ...
                <div className="bg-[#f0f0f0] border-2 border-[#22232a] shadow-2xl flex flex-col w-[95vw] max-w-5xl h-[95vh] overflow-hidden select-none font-sans">
                    ...
                    <div className="modal-header bg-[#106ebe] h-10 px-4 flex justify-between items-center text-white shrink-0 cursor-move border-b border-black">
                        ...
                        <div className="flex items-center gap-2">
                            <button onClick={() => handlePrint()} className="h-7 px-4 bg-blue-600 hover:bg-blue-500 text-white rounded-sm text-[10px] font-semibold uppercase flex items-center gap-2">
                    ...
                    <div className="flex-1 overflow-auto bg-slate-700 p-10 custom-scrollbar shadow-inner">
                        <div ref={printRef} className="bg-white mx-auto p-16 shadow-2xl min-h-full w-[950px] text-black print:shadow-none print:w-full font-serif">
                            ...
                            <div className="text-center mb-10 border-b-2 border-gray-900 pb-8">
                                ...
                                <p className="text-[12px] font-semibold uppercase text-gray-400 tracking-[0.4em] mb-4 font-sans">Control Administrativo de Distribución</p>
                                <div className="flex justify-between items-end bg-slate-50 p-4 border border-slate-100 font-sans">
                                    <div className="text-left">
                                        <h2 className="text-xl font-semibold uppercase text-slate-800 tracking-tight">PLANILLA INTEGRAL DE PROPINAS</h2>
                                        <p className="text-[11px] font-medium text-gray-500">Periodo: {dates.start} al {dates.end}</p>
                                    </div>
                            ...
                            <div className="grid grid-cols-4 gap-4 mb-8">
                                <div className="border border-slate-200 p-4 bg-slate-50"><span className="text-[9px] font-semibold text-slate-400 block mb-1 uppercase">TOTAL BRUTO</span><div className="text-xl font-semibold">{formatCurr(results.netoDisponibleGlobal + results.totalRetencionAdmin)}</div></div>
                                <div className="border border-rose-100 p-4 bg-rose-50 text-rose-600"><span className="text-[9px] font-semibold text-rose-400 block mb-1 uppercase">RETENCIÓN (17%)</span><div className="text-xl font-semibold">-{formatCurr(results.totalRetencionAdmin)}</div></div>
                                <div className="border border-emerald-100 p-4 bg-emerald-50 text-emerald-700 font-sans"><span className="text-[9px] font-semibold text-emerald-400 block mb-1 uppercase">RECIBE MESEROS (55%)</span><div className="text-xl font-semibold">{formatCurr(results.fondoMeserosGlobal)}</div></div>
                                <div className="border border-blue-100 p-4 bg-blue-50 text-blue-700 font-sans"><span className="text-[9px] font-semibold text-blue-400 block mb-1 uppercase">RECIBE APOYO (45%)</span><div className="text-xl font-semibold">{formatCurr(results.fondoApoyoGlobal)}</div></div>
                            </div>

                            {/* Detalle Meseros */}
                            <div className="mb-10">
                                <div className="bg-[#106ebe] text-white px-4 py-2 text-[11px] font-semibold uppercase tracking-widest mb-3 flex justify-between">
                                    <span>PLANILLA MESEROS (55% DE LEY)</span>
                                    <span>{formatCurr(results.fondoMeserosGlobal)}</span>
                                </div>
                                <table className="w-full border-collapse">
                                    <thead><tr className="bg-slate-100 border-b border-black text-[10px] font-semibold uppercase"><th className="px-3 py-2 text-left">COLABORADOR</th><th className="px-3 py-2 text-right">SUBTOTAL 55%</th><th className="px-3 py-2 text-center">VALES</th><th className="px-3 py-2 text-right">TOTAL NETO</th></tr></thead>
                                    <tbody className="text-[12px] font-medium uppercase tracking-tight divide-y divide-slate-100">
                            ...
                            {/* Detalle Apoyo */}
                            <div className="mb-12">
                                <div className="bg-emerald-800 text-white px-4 py-2 text-[11px] font-semibold uppercase tracking-widest mb-3 flex justify-between">
                                    <span>PLANILLA PERSONAL APOYO (45% DE LEY)</span>
                                    <span>{formatCurr(results.fondoApoyoGlobal)}</span>
                                </div>
                                <table className="w-full border-collapse">
                                    <thead><tr className="bg-slate-100 border-b border-black text-[10px] font-semibold uppercase"><th className="px-3 py-2 text-left">COLABORADOR</th><th className="px-3 py-2 text-right">CUOTA BASE</th><th className="px-3 py-2 text-center">VALES</th><th className="px-3 py-2 text-right">TOTAL NETO</th></tr></thead>
                                    <tbody className="text-[12px] font-medium uppercase tracking-tight divide-y divide-slate-100">
                            ...
                            <div className="mt-20 flex justify-around px-8">
                                <div className="w-[250px] border-t-2 border-black pt-4 text-center">
                                    <p className="text-[11px] font-semibold uppercase">ADMINISTRACIÓN</p>
                                    <p className="text-[9px] text-gray-500 mt-1">Autorizado</p>
                                </div>
                                <div className="w-[250px] border-t-2 border-black pt-4 text-center">
                                    <p className="text-[11px] font-semibold uppercase">CONTABILIDAD</p>
                ...
                <div className="w-[1050px] bg-[#fdfdfd] border-2 border-[#106ebe] shadow-2xl flex flex-col overflow-hidden rounded-sm">
                    ...
                    <div className="modal-header bg-[#106ebe] h-10 px-4 flex justify-between items-center cursor-move border-b border-black shadow-[inset_0_1px_0_rgba(255,255,255,0.1)]">
                        <div className="flex items-center gap-2">
                            ...
                            <span className="text-white text-[11px] font-semibold uppercase tracking-widest">Liquidación y Planilla de Propinas</span>
                        </div>
                        <div className="flex items-center gap-3">
                            ...
                            >
                                <Printer size={18} />
                                <span className="text-[9px] font-semibold uppercase">Imprimir / Exportar</span>
                            </button>
                    ...
                    <div className="flex flex-1 overflow-hidden min-h-[620px]">
                        ...
                        <div className="w-[300px] border-r bg-slate-50 p-6 space-y-6">
                            <div className="text-center"><span className="text-[10px] font-semibold text-slate-400 uppercase tracking-widest px-2 bg-slate-100 py-1 rounded-sm shadow-sm ring-1 ring-slate-200">1. Balance Fiscal</span></div>
                            <div className="space-y-4">
                                <div className="text-center py-2 bg-white border border-slate-200 rounded shadow-sm">
                                    <span className="text-[9px] font-semibold text-slate-400 uppercase">Propinas Brutas del Reporte</span>
                                    <div className="text-2xl font-semibold text-slate-800 tracking-tighter">{formatCurr(initialTotalBruta)}</div>
                                </div>
                                <div className="text-center border-2 border-red-100 bg-red-50/50 p-4 rounded-sm shadow-sm">
                                    <span className="text-[9px] font-semibold text-red-500 uppercase">Retención ISR/IVA (17%)</span>
                                    <div className="text-2xl font-semibold text-red-600 tracking-tighter">{formatCurr(results.totalRetencionAdmin)}</div>
                                </div>
                                <div className="text-center bg-[#106ebe] p-5 rounded-sm shadow-2xl relative overflow-hidden group">
                                    <span className="text-[9px] font-semibold text-emerald-400 uppercase tracking-[0.2em] mb-1 block">Total Neto a Pagar</span>
                                    <div className="text-3xl font-semibold text-white tracking-tighter">{formatCurr(results.netoDisponibleGlobal)}</div>
                                </div>
                            </div>
                        </div>
                        ...
                        <div className="flex-1 bg-white p-6 space-y-8 overflow-y-auto">
                            ...
                            <div className="space-y-3">
                                <div className="bg-[#106ebe] h-9 px-4 flex items-center gap-2 rounded-t-sm shadow-sm">
                                    <Users size={16} className="text-blue-400" /><span className="text-white text-[10px] font-semibold uppercase tracking-widest">Planilla Meseros (55% de Ley)</span>
                                </div>
                                <div className="border rounded-b-sm overflow-hidden shadow-sm">
                                    <table className="w-full text-[11px]">
                                        <thead className="bg-slate-100 border-b font-semibold text-slate-500 text-[9px] uppercase">
                                        ...
                                        <tbody className="divide-y font-medium uppercase text-slate-700">
                                            {results.meseros.map((m, i) => (
                                                <tr key={i} className="hover:bg-blue-50/10 divide-x divide-slate-100">
                                                    ...
                                                    <td className="px-4 py-0.5 text-right font-semibold font-mono text-emerald-800 bg-emerald-50/20">{formatCurr(m.total)}</td>
                                                </tr>
                                            ))}
                                        </tbody>
                                        <tfoot className="bg-[#106ebe] text-white font-semibold uppercase text-[10px]"><tr className="divide-x divide-white/10"><td colSpan={5} className="px-4 py-2 text-right">Total Planilla Meseros</td><td className="px-4 py-2 text-right font-mono text-emerald-400">{formatCurr(results.fondoMeserosGlobal)}</td></tr></tfoot>
                                    </table>
                                </div>
                            </div>
                            ...
                            <div className="space-y-3">
                                <div className="bg-[#106ebe] h-9 px-4 flex justify-between items-center rounded-t-sm shadow-sm">
                                    <div className="flex items-center gap-2"><ChefHat size={16} className="text-emerald-400" /><span className="text-white text-[10px] font-semibold uppercase tracking-widest">Personal de Apoyo (45% de Ley)</span></div>
                                    <button onClick={() => setEmployees([...employees, { id: generateUUID(), name: '', vales: 0 }])} className="bg-emerald-600 hover:bg-emerald-500 text-white px-3 h-6 rounded-sm text-[9px] font-semibold uppercase flex items-center gap-1.5 border border-emerald-400/30 transition-none"><UserPlus size={14} /> Agregar Personal</button>
                                </div>
                                <div className="border rounded-b-sm overflow-hidden shadow-sm">
                                    <table className="w-full text-[11px]">
                                        <thead className="bg-slate-100 border-b font-semibold text-slate-500 text-[9px] uppercase">
                                        ...
                                        <tbody className="divide-y font-medium uppercase text-slate-700">
                                            {employees.map(e => (
                                                <tr key={e.id} className="hover:bg-emerald-50/10 divide-x divide-slate-100">
                                                    <td className="px-4 py-1.5"><input type="text" className="w-full h-8 bg-transparent outline-none font-medium placeholder:text-slate-300" placeholder="NOMBRE COLABORADOR..." value={e.name} onChange={v => setEmployees(p => p.map(em => em.id === e.id ? ({ ...em, name: v.target.value }) : em))} /></td>
                                                    ...
                                                    <td className="px-4 py-1.5 text-right font-semibold font-mono text-emerald-800 bg-emerald-50/20">{formatCurr(results.basePorPersonaApoyo - e.vales)}</td>
                                        ...
                                        <tfoot className="bg-[#106ebe] text-white font-semibold uppercase text-[10px]"><tr className="divide-x divide-white/10"><td colSpan={2} className="px-4 py-2 text-right">Total Planilla Apoyo</td><td className="px-4 py-2 text-right font-mono text-emerald-400">{formatCurr(results.fondoApoyoGlobal)}</td><td /></tr></tfoot>
                                    </table>
                                </div>
                            </div>
                        </div>
            ...
            <DraggableWindow>
                <div className="w-[900px] h-[600px] bg-white border-2 border-[#106ebe] shadow-2xl flex flex-col overflow-hidden animate-in zoom-in-95 rounded-sm">
                    <div className="modal-header bg-[#106ebe] h-10 px-4 flex justify-between items-center cursor-move border-b border-black">
                        <div className="flex items-center gap-2 font-semibold text-[12px] text-white uppercase"><History size={18} className="text-blue-400" /> Auditoría Histórica</div>
                        ...
                        <div className="w-1/3 border-r bg-slate-50 overflow-y-auto divide-y">
                            {distHistory.map(h => (
                                <div key={h.id} onClick={() => handleSelect(h)} className={`p-4 cursor-pointer hover:bg-white transition-all ${selectedDist?.id === h.id ? 'bg-white border-l-4 border-blue-600' : ''}`}>
                                    <div className="text-[11px] font-semibold">{dayjs(h.created_at).format('DD/MM/YYYY HH:mm')}</div>
                                    <div className="text-[9px] font-medium text-slate-400 uppercase">{h.branches?.name || 'GENERAL'}</div>
                                    <div className="text-[11px] font-semibold text-emerald-600 font-mono mt-1">{formatCurr(h.total_bruta)}</div>
                                </div>
                            ))}
                        </div>
                        <div className="flex-1 flex flex-col overflow-hidden">
                            {selectedDist ? (
                                <div className="flex-1 flex flex-col">
                                    <div className="p-4 bg-slate-50 border-b flex justify-between items-center"><div><span className="text-[9px] font-semibold text-slate-400 uppercase">Total Bruto</span><div className="text-xl font-semibold">{formatCurr(selectedDist.total_bruta)}</div></div><div className="text-right font-semibold text-red-600"><span className="text-[9px] text-slate-400 uppercase leading-none">Retención</span><div className="text-xl">{formatCurr(selectedDist.retencion_manual)}</div></div></div>
                                    <div className="flex-1 overflow-y-auto p-4">
                                        <table className="w-full text-[11px] uppercase font-medium text-slate-700">
                                            <thead className="bg-slate-50 text-[9px] font-semibold text-slate-500 border-b"><tr><th className="px-3 py-2 text-left">Colaborador</th><th className="px-3 py-2 text-center">Tipo</th><th className="px-3 py-2 text-right">Neto</th></tr></thead>
                            ...
                            ) : <div className="flex-1 flex items-center justify-center text-slate-300 font-semibold uppercase text-[10px]">Selecciona un registro</div>}
                        </div>
                    </div>
                </div>
            </DraggableWindow>
    ...
    return (
        <div className="flex flex-col h-full bg-[#f8fafc] text-[11px]">
            ...
            <div className="bg-white border-b-2 border-slate-200 p-4 flex items-center flex-wrap gap-4 shadow-sm">
                <div className="flex flex-col gap-0.5"><span className="text-[9px] font-semibold uppercase text-slate-400">Sucursal:</span><select value={selectedBranch} onChange={e => setSelectedBranch(e.target.value)} className="h-8 border border-slate-300 rounded px-2 font-medium bg-slate-50 outline-none w-48"><option value="all">TODAS LAS SUCURSALES</option>{branches.map(b => <option key={b.id} value={b.id}>{b.name}</option>)}</select></div>
                <div className="flex items-center gap-3 bg-slate-100 p-2 rounded-sm border border-slate-200">
                    <div className="flex items-center gap-1.5"><span className="text-[9px] font-semibold uppercase text-slate-500">Del:</span><input type="date" value={startDate} onChange={e => setStartDate(e.target.value)} className="h-7 border border-slate-400 px-2 rounded-sm font-mono font-medium" /><input type="time" value={startTime} onChange={e => setStartTime(e.target.value)} className="h-7 border border-slate-400 px-1 rounded-sm font-mono font-medium" /></div>
                    <div className="flex items-center gap-1.5"><span className="text-[9px] font-semibold uppercase text-slate-500">Al:</span><input type="date" value={endDate} onChange={e => setEndDate(e.target.value)} className="h-7 border border-slate-400 px-2 rounded-sm font-mono font-medium" /><input type="time" value={endTime} onChange={e => setEndTime(e.target.value)} className="h-7 border border-slate-400 px-1 rounded-sm font-mono font-medium" /></div>
                </div>
                <div className="ml-auto flex items-center gap-3">
                    <button onClick={handleGenerate} className="bg-[#106ebe] text-white px-5 h-8 font-semibold uppercase text-[10px] flex items-center gap-2 rounded-sm active:scale-95 transition-transform"><Search size={14} /> GENERAR</button>
                    <button onClick={() => setShowDistributionModal(true)} className="bg-[#106ebe] text-white px-5 h-8 font-semibold uppercase text-[10px] flex items-center gap-2 rounded-sm active:scale-95 transition-transform"><ClipboardCheck size={14} /> DISTRIBUCIÓN APOYO</button>
                    <button onClick={() => setShowHistoryModal(true)} className="bg-[#106ebe] text-white px-5 h-8 font-semibold uppercase text-[10px] flex items-center gap-2 rounded-sm active:scale-95 transition-transform"><History size={14} /> HISTORIAL</button>
                    <button
                        onClick={() => setShowPrintModal(true)}
                        disabled={data.length === 0}
                        className="bg-white border text-slate-700 px-5 h-8 font-semibold uppercase text-[10px] flex items-center gap-2 rounded-sm active:scale-95 transition-transform border-slate-300 shadow-sm"
                    >
            ...
            <div className="bg-slate-50 border-b border-slate-200 px-4 py-2 flex items-center gap-2">
                ...
                <input type="text" placeholder="BUSCAR POR NOMBRE POR USUARIO / MESERO..." value={searchTerm} onChange={e => setSearchTerm(e.target.value)} className="w-full bg-transparent outline-none font-medium text-slate-600 placeholder:text-slate-300 h-6" />
            </div>

            {/* TABLA PRINCIPAL */}
            <div className="flex-1 overflow-y-auto bg-white">
                <table className="w-full border-separate border-spacing-0">
                    <thead className="sticky top-0 z-30 bg-slate-100 text-slate-800 uppercase font-medium text-[10px]">
                        <tr className="divide-x divide-slate-200">
                    ...
                    <tbody className="divide-y divide-slate-100 uppercase">
                        {data.length === 0 && !loading && (<tr><td colSpan={8} className="py-20 text-center text-slate-300 font-semibold uppercase text-[12px] opacity-40">No se han encontrado registros</td></tr>)}
                        {data.map(w => {
                            ...
                            return (
                                <React.Fragment key={w.name}>
                                    <tr onClick={() => toggleWaiter(w.name)} className="bg-slate-50/70 hover:bg-slate-100 cursor-pointer border-y border-slate-200 group font-semibold text-slate-800 uppercase">
                                        ...
                                        <>
                                            {w.orders.map((o: any) => (
                                                <tr
                                                    ...
                                                    className={`divide-x divide-slate-100 font-medium transition-colors cursor-default ${selectedOrderId === o.id ? 'selected-row-custom' : 'text-slate-600 hover:bg-blue-50/30'}`}
                                                >
                                                    <td className="px-6 py-1.5 text-slate-400 font-mono text-[9px]">{dayjs(o.fecha).format('DD/MM/YYYY HH:mm')}</td>
                                                    <td className="px-4 py-1.5 text-center text-slate-800 font-semibold">{o.no_orden}</td>
                                                    ...
                                                    <td className="px-4 py-1.5 text-right font-mono font-semibold text-slate-900 bg-slate-50/50">{formatCurr(o.total)}</td>
                                                </tr>
                                            ))}
                                            <tr className="bg-slate-100/80 font-semibold text-slate-800 uppercase border-b-2 border-slate-300 divide-x divide-slate-200 shadow-[inset_0_2px_4px_rgba(0,0,0,0.05)]">
                    ...
                    {data.length > 0 && (
                        <tfoot className="sticky bottom-0 z-30 bg-white text-slate-800 border-t-2 border-gray-300 shadow-[0_-4px_15px_rgba(0,0,0,0.05)] font-semibold uppercase text-[11px] divide-x divide-gray-200">
                            <tr className="h-8">
                        ...
                        <div className="bg-[#f0f2f5] border-2 border-[#106ebe] shadow-2xl flex flex-col w-[450px] overflow-hidden select-none font-sans">
                            ...
                            <div className="modal-header bg-[#106ebe] h-12 px-4 flex justify-between items-center text-white shrink-0 cursor-move border-b border-black">
                                <div className="flex items-center gap-3">
                                    ...
                                    <span className="text-[12px] font-semibold uppercase tracking-wider">Auditoría de Propina - Orden #{editOrder.no_orden}</span>
                                </div>
                            ...
                            <div className="p-5 space-y-4">
                                ...
                                <div className="bg-white border border-slate-200 p-4 rounded-sm space-y-3">
                                    ...
                                    <div className="flex items-center gap-3 py-1 border-t border-slate-50">
                                        ...
                                        <div className="flex flex-col">
                                            <span className="text-[9px] font-semibold text-slate-400 uppercase leading-tight">Atendido por:</span>
                                            <span className="text-[11px] font-semibold text-slate-700 uppercase leading-tight">{editOrder.waiter_name || '---'}</span>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div className="space-y-1.5">
                                    <div className="flex items-center gap-2 text-[10px] font-semibold text-slate-500 uppercase tracking-tighter">
                                        <Navigation size={12} className="text-blue-500 rotate-45" />
                                        <span>Asignación de Mesero</span>
                                    </div>
                                    <select
                                        className="w-full h-10 border border-slate-300 px-3 text-[11px] font-semibold uppercase text-slate-700 bg-white"
                                ...
                                <div className="grid grid-cols-2 gap-4">
                                    <div className="space-y-1.5">
                                        ...
                                        <input
                                            type="number"
                                            className="w-full h-10 border border-slate-300 px-3 font-mono font-medium text-slate-800 text-lg"
                                ...
                                <div className="bg-[#106ebe] rounded-sm p-5 flex justify-between items-center shadow-lg">
                                    <div className="flex flex-col">
                                        <span className="text-[9px] font-semibold text-slate-400 uppercase tracking-widest">Liquidación Final</span>
                                        <span className="text-[12px] font-medium text-white uppercase">Cruce de Cuentas</span>
                                    </div>
                                    <div className="flex flex-col items-end">
                                        <span className="text-[9px] font-semibold text-blue-400 uppercase tracking-widest leading-none mb-1">Total Propina</span>
                                        <div className="text-3xl font-semibold text-white flex items-center gap-2 leading-none">
                                ...
                                <div className="bg-amber-50 border border-amber-200 p-3 flex gap-3 items-start">
                                    ...
                                    <p className="text-[10px] font-medium text-amber-800 leading-tight uppercase">
                        ...
                        <div className="bg-[#f0f0f0] border-2 border-[#106ebe] shadow-2xl flex flex-col w-[90vw] max-w-6xl h-[90vh] overflow-hidden select-none font-sans">
                            ...
                            <div className="modal-header bg-[#106ebe] h-10 px-4 flex justify-between items-center text-white shrink-0 cursor-move border-b border-black shadow-[inset_0_1px_0_rgba(255,255,255,0.1)]">
                                ...
                                <div className="flex items-center gap-2">
                                    <button
                                        onClick={() => handlePrint()}
                                        className="h-7 px-4 bg-blue-600 hover:bg-blue-500 text-white rounded-sm text-[10px] font-semibold uppercase flex items-center gap-2 shadow-sm active:scale-95 transition-transform"
                                    >
                                        <Printer size={12} strokeWidth={3} /> IMPRIMIR PDF
                                    </button>
                                    <button
                                        ...
                                        className="h-7 px-4 bg-emerald-600 hover:bg-emerald-500 text-white rounded-sm text-[10px] font-semibold uppercase flex items-center gap-2 shadow-sm active:scale-95 transition-transform border border-emerald-400/30"
                                    >
                            ...
                            <div className="flex-1 overflow-auto bg-slate-700/80 p-10 custom-scrollbar scroll-smooth">
                                ...
                                >
                                    ...
                                    <div className="text-center mb-12 border-b-2 border-gray-900 pb-8">
                                        <h1 className="text-5xl font-semibold uppercase tracking-tighter mb-1 font-sans">RESTAURANTE LAS PALMAS</h1>
                                        <p className="text-[14px] font-semibold uppercase tracking-[0.5em] text-gray-500 mb-6 font-sans">Sistema de Control Administrativo</p>
                                        <div className="flex justify-between items-end px-2">
                                            <div className="text-left">
                                                <h2 className="text-2xl font-semibold uppercase text-slate-800 font-sans border-l-4 border-blue-600 pl-4 py-1 bg-slate-50">REPORTE DE DISTRIBUCIÓN DE PROPINAS</h2>
                                                <p className="text-[12px] font-medium text-gray-500 mt-2">Periodo Seleccionado: {dayjs(startDate).format('DD/MM/YYYY')} - {dayjs(endDate).format('DD/MM/YYYY')}</p>
                                            </div>
                                            <div className="text-right">
                                                <p className="text-[12px] font-medium text-gray-800 uppercase tracking-wider">Sucursal: {selectedBranch === 'all' ? 'TODAS LAS SUCURSALES' : (branches.find(b => b.id === selectedBranch)?.name || 'SALA')}</p>
                                    ...
                                    <div className="grid grid-cols-3 gap-6 mb-12">
                                        <div className="bg-slate-50 border-2 border-slate-100 p-5 rounded-sm">
                                            <span className="text-[10px] font-semibold text-slate-400 uppercase tracking-widest block mb-1">PROPINAS BRUTAS</span>
                                            <div className="text-2xl font-semibold text-slate-900 tabular-nums">{formatCurr(tipTotalTotal)}</div>
                                        </div>
                                        <div className="bg-rose-50 border-2 border-rose-100 p-5 rounded-sm">
                                            <span className="text-[10px] font-semibold text-rose-400 uppercase tracking-widest block mb-1">RETENCIÓN ISR/IVA (17%)</span>
                                            <div className="text-2xl font-semibold text-rose-600 tabular-nums">-{formatCurr(retention)}</div>
                                        </div>
                                        <div className="bg-blue-600 p-6 rounded-sm shadow-lg">
                                            <span className="text-[10px] font-semibold text-blue-200 uppercase tracking-widest block mb-1">FONDO NETO REPARTIBLE</span>
                                            <div className="text-3xl font-semibold text-white tabular-nums tracking-tighter shadow-sm">{formatCurr(netFund)}</div>
                                        </div>
                                    </div>
                                    ...
                                    <div className="mb-12">
                                        <div className="flex items-center gap-3 mb-4">
                                            ...
                                            <h3 className="text-[16px] font-semibold uppercase tracking-tight text-slate-800">Planilla de Meseros (55% de Ley - {formatCurr(netFund * 0.55)})</h3>
                                        </div>
                                        <table className="w-full border-collapse">
                                            <thead>
                                                <tr className="bg-slate-200 text-slate-900 text-[10px] font-semibold uppercase tracking-widest">
                                                ...
                                                {waitersData.map((w, i) => {
                                                    ...
                                                    return (
                                                        <tr key={i} className="border-b border-slate-200 h-10 hover:bg-slate-50">
                                                            ...
                                                            <td className="px-5 text-right tabular-nums font-semibold text-slate-950 bg-emerald-50/20">{formatCurr(amount)}</td>
                                                        </tr>
                                                    );
                                                })}
                                            </tbody>
                                            <tfoot>
                                                <tr className="bg-slate-100 font-semibold h-12">
                                                    <td colSpan={3} className="px-5 text-right uppercase text-[11px] tracking-widest">SUBTOTAL PLANILLA MESEROS</td>
                                                    <td className="px-5 text-right text-[14px] font-semibold text-slate-900 border-t-2 border-slate-900">{formatCurr(netFund * 0.55)}</td>
                                                </tr>
                                            </tfoot>
                                        </table>
                                    </div>
                                    ...
                                    <div className="mt-24 flex justify-between px-16">
                                        <div className="w-[280px] border-t-2 border-slate-900 text-center pt-4">
                                            <p className="text-[12px] font-semibold uppercase tracking-tighter">Firma Responsable Operativo</p>
                                            <p className="text-[10px] font-medium text-gray-500 mt-1 uppercase block">Elaborado por: {currentUser?.name || '---'}</p>
                                        </div>
                                        <div className="w-[280px] border-t-2 border-slate-900 text-center pt-4">
                                            <p className="text-[12px] font-semibold uppercase tracking-tighter">Vo.Bo. Administración / Gerencia</p>
                                            <p className="text-[10px] font-medium text-gray-500 mt-1 uppercase block">Sello de Autorización</p>
                                        </div>
                                    </div>
