/**
 * DOMINIO 2 — PRODUCTOS / MATERIA PRIMA
 * Sidebar exclusivo de Materia Prima.
 * SOLO lee / escribe: product_categories
 * NUNCA toca: menu_categories, supply_categories,
        ...
        <>
            ...
            {form && createPortal(
                <div className="fixed inset-0 z-[200000] flex items-center justify-center p-4 pointer-events-none">
                    ...
                    <DraggableWindow id="product-category-modal" title="Mantenimiento de Categorías">
